...
```
 That is looking great--final edits to come.
 
```{r}

# I want to redefine my bounding box to show more of Australia and less of the open ocean.
...
# Let's create a better label vector and join it to our data.
reglabs <- tribble(
  ~Region, ~Label,
...
draftmap3 <- tm_shape(shelf, bbox = sfausbox)+
  ...
  tm_layout(main.title = "Largest Fisheries by Species for Queensland Otter Trawl, 1990-2022", main.title.position = "center", legend.position = c("left", "bottom"), legend.frame = TRUE, legend.bg.color = "white", bg.color = "gray96", frame.double.line = TRUE, frame.lwd = 1, fontfamily = "serif", fontface = "bold")
